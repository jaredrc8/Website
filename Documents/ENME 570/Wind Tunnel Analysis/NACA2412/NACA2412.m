...
% Read Data
Data_force = readmatrix('NACA2412_Lift.xlsx', 'range', 'b6:b564');
Data_Angle = readmatrix('NACA2412_Lift.xlsx', 'range', 'au6:au564');
...
ylabel('CL');
title('CL vs Angle of Attack for NACA2412 Airfoil');
grid on;


% Read Data For Drag
Data_force_2 = readmatrix('NACA2412_Drag.xlsx', 'range', 'b6:b563');
Data_Angle_2 = readmatrix('NACA2412_Drag.xlsx', 'range', 'au6:au563');
...
xlabel('Angle of Attack (degrees)');
ylabel('CD');
title('CD vs Angle of Attack for NACA2412 Airfoil');
grid on;
